        ...
        <Main>
            ...
            <Lane className="right">
                <div ref={el => (divRefs.current[1] = el)}>
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"} src="./img/Eva Black/3.webp" />
                    </Project>    
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"} src="./img/Eva Black/4.webp" />
                    </Project>    
                </div>
            </Lane>
        </Main>
