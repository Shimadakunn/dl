        ...
        <Main>
            <Lane className="left">
                <div ref={el => (divRefs.current[0] = el)}>    
                    ...
                    <Project className="paysage">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/3.webp" />
                    </Project>   
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/6.webp" />
                    </Project> 
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/7.webp" />
                    </Project>  
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/9.webp" />
                    </Project>  
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/11.webp" />
                    </Project>  
                </div>
            </Lane>
            <Lane className="right">
                <div ref={el => (divRefs.current[1] = el)}>
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/2.webp" />
                    </Project> 
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/4.webp" />
                    </Project> 
                    <Project className="paysage">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/5.webp" />
                    </Project>  
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/8.webp" />
                    </Project> 
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Ethan/10.webp" />
                    </Project> 
                </div>
            </Lane>
        </Main>
