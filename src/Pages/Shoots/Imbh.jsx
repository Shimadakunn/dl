        ...
        <Main>
            <Lane className="left">
                <div ref={el => (divRefs.current[0] = el)}>    
                    ...
                    <Project className="paysage">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/3.webp" />
                    </Project>   
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/5.webp" />
                    </Project>  
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/7.webp" />
                    </Project>  
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/9.webp" />
                    </Project>  
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/11.webp" />
                    </Project>  
                </div>
            </Lane>
            <Lane className="right">
                <div ref={el => (divRefs.current[1] = el)}>
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/2.webp" />
                    </Project> 
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/4.webp" />
                    </Project> 
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/6.webp" />
                    </Project> 
                    <Project className="paysage">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/8.webp" />
                    </Project> 
                    <Project className="portraitBis">
                        <img className={loading?"":"notloaded"}src="./img/Imbh/10.webp" />
                    </Project> 
                </div>
            </Lane>
        </Main>
