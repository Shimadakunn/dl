        ...
        <Main>
            ...
            <Lane className="left">
                <div ref={el => (divRefs.current[0] = el)}>  
                    ...
                    <Project className="portrait">
                        <img src="./img/Eva Clem/1.webp" />
                    </Project>   
                    <Project className="portrait">
                        <img src="./img/Eva Clem/2.webp" />
                    </Project>   
                    <Project className="portrait">
                        <img src="./img/Eva Clem/3.webp" />
                    </Project>          
                </div>
            </Lane>
            <Lane className="right">
                <div ref={el => (divRefs.current[1] = el)}>
                    <Project className="portrait">
                        <img src="./img/Eva Clem/4.webp" />
                    </Project>   
                    <Project className="portrait">
                        <img src="./img/Eva Clem/5.webp" />
                    </Project>   
                    <Project className="paysage">
                        <img src="./img/Eva Clem/6.webp" />
                    </Project>   
                    <Project className="portrait">
                        <img src="./img/Eva Clem/7.webp" />
                    </Project>   
                </div>
            </Lane>
        </Main>
