...
function Dou() {
    ...
    return (
        <Main>
            <Title>EVA WITCH</Title>
            <Lane className="left">
                <div ref={el => (divRefs.current[0] = el)}> 
                    <Project className="paysage">
                        <img className={loading?"":"notloaded"} src="./img/Eva Witch/0.webp" />
                    </Project>    
            ...
            <Lane className="right">
                <div ref={el => (divRefs.current[1] = el)}>
                    <Project className="portrait">
                        <img className={loading?"":"notloaded"} src="./img/Eva Witch/2.webp" />
                    </Project>   
                    <Project className="paysage">
                        <img className={loading?"":"notloaded"} src="./img/Eva Witch/3.webp" />
                    </Project>   
                </div>
            </Lane>
        </Main>
